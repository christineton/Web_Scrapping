...
// * Insert data into the travel_db database with this command.
  ...
  // - NOTE: This will also create the collection automatically, the contents of 
  // the insert are basically a JavaScript object, and include an array.
db.destinations.insert({"continent": "Africa", "country": "Morocco",
                        "major_cities": ["Casablanca", "Fez", "Marrakech"]})
// * As a class, come up with 3-5 more countries and insert them into the db using the same 
// syntax as above.
